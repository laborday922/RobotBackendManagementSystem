...
public class FunctionConstants {
    ...
    /** 地图文件上传路径（不要以斜杠开头） */
    public static final String MAP_UPLOAD_PATH = "uploads/map";

    /** 音频文件上传路径 */
    public static final String AUDIO_UPLOAD_PATH = "uploads/audio";

    /** 媒体文件上传路径 */
    public static final String MEDIA_UPLOAD_PATH = "uploads/media";
