...
CREATE TABLE `tm_task` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `task_name_index` (`name`,`tenant_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=2871 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='任务执行日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tm_template` (
  ...
  `tenant_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `template_name_index` (`name`,`tenant_id`)
...
-- Dump completed on 2026-04-22 15:04:35
